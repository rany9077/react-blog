            ...
            <div className="post__detail">
                <div className="post__box">
                    <div className="post__title">
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum fugit odit a porro ullam. Maiores esse quisquam fugiat, voluptas id veniam iure, sed ratione officiis porro atque eligendi perspiciatis aliquid.
                    </div>
